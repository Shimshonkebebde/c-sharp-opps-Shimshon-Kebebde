...
namespace c_sharp_opps_Shimshon_Kebebde.BankApp
{
    public class TestAccount
    {
        public static void Test1()
        {
            ...
            bool allPassed = true;
            if (account1.GetOwner().GetFn().Equals(firstName))
            {
            ...
            else
            {
                Console.Error.WriteLine("Error at Test1 owner first name at accout. expected = " + firstName
                    + "| actual = " + account1.GetOwner().GetFn());
                allPassed = false;
            }

            if (account1.GetOwner().GetLn().Equals(lastName))
            {
            ...
            else
            {
                Console.Error.WriteLine("Error at Test2 owner last name at accout. expected = " + lastName
                    + "| actual = " + account1.GetOwner().GetLn());
                allPassed = false;
            ...
            Console.WriteLine("Testing owner creation");
            if (account2.GetOwner().GetFn().Equals(firstName))
            {
            ...
            else
            {
                Console.Error.WriteLine("Error at Test4 owner first name at accout. expected = " + firstName
                    + "| actual = " + account2.GetOwner().GetFn());
                allPassed = false;

            }

            if (account2.GetOwner().GetLn().Equals(lastName))
            {
            ...
            else
            {
                Console.Error.WriteLine("Error at Test5 owner last name at accout. expected = " + lastName
                    + "| actual = " + account2.GetOwner().GetLn());
                allPassed = false;
